...
json format_timing_report(llama_server_context & llama)
{
	...
	const json tensor_type_json = llama.extra.tensor_type_map;
	const json meta_json = llama.extra.meta_map;
	...
	const json system_json = json{ {"ctx_size", llama.n_ctx},
								  {"cuda_str", llama.extra.cuda_str},
								  {"gpu_name", gpuName},
								  {"mem_required", llama.extra.mem_required},
								  {"offloading_repeating", llama.extra.offloading_repeating},
								  {"offloading_nonrepeating", llama.extra.offloading_nonrepeating},
								  {"offloaded", llama.extra.offloaded},
								  {"offloaded_total", llama.extra.offloaded_total},
								  {"vram_used", llama.extra.vram_used},
								  {"vram_per_layer_avg", llama.extra.vram_per_layer_avg},
								  {"model_path", llama.params.model},
								  {"model_file_name", model_file_name},
								  {"model_name", model_name},
								  {"model_alias", llama.params.model_alias},
								  {"quantization", quantization},
								  {"has_next_token", llama.extra.has_next_token} };
...
// TODO: add mount point without "/v1" prefix -- how?
	...
	svr.Options(R"(/.*)", [](const httplib::Request &, httplib::Response &res) { return res.set_content("", "application/json; charset=utf-8"); });
...
// set timeouts and change hostname and port
	...
	// create a callback that calls format_timing_report with the llama context to be passed to inferenceThread
	//const auto metrics_reporting_thread_callback = [&llama]() {
